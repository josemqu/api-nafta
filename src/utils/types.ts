...
export enum Empresabandera {
  ...
  DapsaSA = "DAPSA S.A.",
  Gulf = "GULF",
  OilCombustiblesSA = "OIL COMBUSTIBLES S.A.",
  Puma = "PUMA",
  Refinor = "REFINOR",
  ShellCAPSA = "SHELL C.A.P.S.A.",
  SinEmpresaBandera = "SIN EMPRESA BANDERA",
  Voy = "VOY",
  Ypf = "YPF",
}
...
export enum Producto {
  GasOilGrado2 = "Gas Oil Grado 2",
  GasOilGrado3 = "Gas Oil Grado 3",
  Gnc = "GNC",
  NaftaPremiumDeMásDe95Ron = "Nafta (premium) de más de 95 Ron",
  NaftaSúperEntre92Y95Ron = "Nafta (súper) entre 92 y 95 Ron",
}
